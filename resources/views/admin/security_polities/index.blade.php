        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/security_polities/1" enctype="multipart/form-data">
                            @csrf
                            @method("PATCH")
                            ...
                            <div class="form-group row">
                                <label for="hospitalized" class="col-2 col-form-label">住院治療低於 (次)</label>
                                <div class="col-10">
                                    <input class="form-control" id="hospitalized" name="hospitalized" value="{{ $list->hospitalized }}" required>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
