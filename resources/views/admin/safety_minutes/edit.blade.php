    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/safety_minutes/{{$list->id}}" enctype="multipart/form-data">
                        @csrf
                        @method("PATCH")
                        ...
                        <div class="form-group row">
                            <label for="img" class="col-2 col-form-label">紀錄檔案 (目前檔案)</label>
                        ...
                        <div class="form-group row">
                            <label for="attachments" class="col-2 col-form-label">紀錄檔案 (新增檔案)</label>
                            <div class="col-10">
