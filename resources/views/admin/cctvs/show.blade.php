                ...
                <div class="card-body">
                    <form method="POST" action="/admin/cctvs/{{$list->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" id="title" name="title" value="{{ $list->title }}" disabled required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="cctv_title" class="col-2 col-form-label">CCTV名稱</label>
                            <div class="col-10">
                                <input class="form-control" id="cctv_title" name="cctv_title" value="{{ $list->cctv_title }}" disabled required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="url" class="col-2 col-form-label">網址</label>
                            <div class="col-10">
                                <input class="form-control" id="url" name="url" value="{{ $list->url }}" disabled required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="account" class="col-2 col-form-label">帳號</label>
                            <div class="col-10">
                                <input class="form-control" id="account" name="account" value="{{ $list->account }}" disabled required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password" class="col-2 col-form-label">密碼</label>
                            <div class="col-10">
                                <input class="form-control" id="password" name="password" value="{{ $list->password }}" disabled required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="{{ $item->name }}" name="assign_names[]" disabled
